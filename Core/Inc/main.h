...
#define Transmitter_Pin GPIO_PIN_6
#define Transmitter_GPIO_Port GPIOA
#define Receiver_Pin GPIO_PIN_7
#define Receiver_GPIO_Port GPIOA
...
#define SignalLed_Pin GPIO_PIN_6
#define SignalLed_GPIO_Port GPIOB
